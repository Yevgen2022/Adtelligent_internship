...
export default function About() {
  return (
    <section className="mx-auto max-w-[calc(56rem+600px)] px-4 py-10">
      <div className="grid gap-6 lg:grid-cols-[300px_56rem_300px] justify-center">
        <aside className="hidden lg:block">
          <h3 className="text-lg font-semibold mb-2">Ad (Bidmatic)</h3>
          <Advertisement
            code="about-left-bidmatic"
            sizes={[[300, 250]]}
        ...
        <section className="mx-auto max-w-4xl">
          <header className="mb-8">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Internship project at Adtelligent: a news website with the
              potential for future integration of advertising modules.
            </p>
          </header>
          ...
          <section className="rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-gray-700">
              ...
              prepared for scaling (pages, modals, lists, detail views), as well
              as for integration of advertising solutions (ad slots, A/B tests,
              performance metrics).
            </p>
          </section>
          ...
          <section className="mt-6 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-gray-700">
              ...
              in-feed, in-article), configuration flags, and metrics tracking
              (CTR, viewability). The page architecture is designed for flexible
              component integration without major content changes.
            </p>
          </section>
          ...
          <section className="mt-6 rounded-2xl border bg-white p-6 shadow-sm">
            ...
            <div className="mt-3 space-y-2 text-gray-700">
              ...
              <p>
                Deployment:{" "}
                <span className="text-gray-900 font-medium">Vercel</span>{" "}
                (Preview for PRs, Production from <code>main</code>).
              </p>
              <p className="text-sm text-gray-500">
                *This page is for demonstration and educational purposes within
                the internship.
              </p>
            </div>
          </section>
