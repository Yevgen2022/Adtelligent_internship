...
const FORM_PATH = `${API_URL}/api/adserver/lineitem/form`;
const BACKEND_ORIGIN = import.meta.env.VITE_BACKEND_ORIGIN as string | undefined;
...
export default function Creative() {
    ...
    // load HTML forms from the backend
    useEffect(() => {
        let cancelled = false;
        const load = async () => {
            try {
    ...
    useEffect(() => {
        ...
        const form = rootRef.current.querySelector("form") as HTMLFormElement | null;
        if (!form) return;
        ...
        const onSubmit = async (e: Event) => {
            ...
            try {
                ...
                // successful → reset the form and show the message
                form.reset();
    ...
    // auto-disappearance of message after 5 seconds
    useEffect(() => {
    ...
    return (
        <div className="mx-auto max-w-4xl px-4 py-6">
            <header className="mb-6">
                <h1 className="text-2xl font-semibold tracking-tight">Create Line Item</h1>
                <p className="text-sm text-neutral-600">
                    This page embeds the server-rendered form from the backend. Submitting the form
                    will upload the creative file and create a Line Item in the backend.
                </p>
            </header>
            ...
            <div className="mt-6 text-sm text-neutral-600">
                ...
                <a className="underline" href={FORM_URL} target="_blank" rel="noreferrer">
